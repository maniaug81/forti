terraform {
  backend "s3" {
    bucket         = "ect-nw-terraform-state-s3"
    key            = "terraform/ect-nw-terraform-fortinet.tfstate"
...
variable "iam" {
  default = "ect-nw-fortinet-ha-role" //Put in the IAM Role name created
}

variable "vpcid" {
  description = "VPC ID"
  default     = "vpc-0533aec734abab30c"
}
